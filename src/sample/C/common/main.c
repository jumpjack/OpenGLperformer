...
main(int argc, char *argv[])
{
    ...
    */
    ...
    /* 
     * If environment variable PERFLY_EVENT_FILE is set, initialize
     * event generation.
     */
    if( getenv("PERFLY_EVENT_FILE") )
    {
	pfNotify( PFNFY_NOTICE, PFNFY_PRINT,
	    "Environment Variable PERFLY_EVENT_FILE is set.");
	pfInitializeEvents();
    	pfEventSampleOn();
    }
    ...
    */
    ...
    /* 
     * If environment variable PERFLY_EVENT_FILE is set, stop generating
     * events and write them all to file.
     */
    {
        char* e = getenv("PERFLY_EVENT_FILE");
	if( e )
	{
	    if( *e == '\0' )
	        e = "perfly_events.timefile";

	    pfNotify( PFNFY_NOTICE, PFNFY_PRINT,
		"Saving events to file %s.", e );
