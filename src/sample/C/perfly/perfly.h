...
#if 0
/* use ViewState->master_pipe_index */
    int master_elt; 
#endif
...
typedef struct
{
    ...
    int             useOverlay;         /* Flag to show overlay text */
    ...
    int	    	    snapFrame;		/* snapshot after this many frames */
    char*	    snapFile;		/* snapshot after this many frames */
    ...
    float	    fov[4];             /* fovH, fovV, and channel offset */
    ...
    int            shaders; /* enable/disable pfShadPrograms */
} SharedViewState;
...
extern void updateSmallFeatureCulling(float size);
