...
#if defined(WIN32) && !defined(PFSTATICLIB)
...
#define PFPFB_DISABLE_REP_SAVE            7
#define PFPFB_SUBDIVSURFACE_SAVE_GEOSETS  8
...
extern PFPFB_DLLEXPORT pfNode*  pfdLoadFile_pfb_fromMemory(int size, 
    unsigned char *addr);
...
extern PFPFB_DLLEXPORT void     pfdSetTessellationAction(pfTessParaSurfaceAction *action);
extern PFPFB_DLLEXPORT pfTessParaSurfaceAction *pfdGetTessellationAction();
